...
courses = [{'course':"Frontend Web Development", 'language': "HTML • CSS • Bootstrap", 'price':0},
           {'course':"Python Programming Language", 'language': "Python", 'price':5},          {'course':"Backend Development", 'language': "Python • Flask • SQL", 'price':10}, {'course':"SQL Database", 'language': "Python • SQL", 'price':2}, {'course':"Mongo Database", 'language': "Mongo • Python", 'price':5}, {'course':"Ultimate Dropshipping", 'price':5},  {'course':"Java Programming Language", 'language': "Java", 'price':5}, {'course':'Kotlin Programming Language', 'language': "Kotlin", 'price':5}, {'course':"Dart Programming Language", 'language': 'Dart', 'price':5}, {'course':'Swift Programming Language', 'language':'Swift', 'price':5},         {'course':"UI/UX Design Principles", 'price':2}]
